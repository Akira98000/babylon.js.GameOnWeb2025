    ...
    RGBDTextureTools = class {
      ...
      static ExpandRGBDTexture(texture) {
        ...
        const expandRGBDTexture = async () => {
          ...
          internalTexture.isReady = false;
          if (isWebGPU) {
            await import("./rgbdDecode.fragment-B5G743WI.js");
          } else {
            await import("./rgbdDecode.fragment-MLNLX6QL.js");
          }
      ...
      static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
          await import("./rgbdEncode.fragment-GT3VT5JC.js");
        } else {
          await import("./rgbdEncode.fragment-WLBDVDAZ.js");
        }
...
//# sourceMappingURL=chunk-LZV6WUOJ.js.map
